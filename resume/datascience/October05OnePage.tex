...
\par{\centering{\sffamily\Huge Shawn Anderson}\\ \\% Your name
\par{\textbf{Recent graduate of computing science at University of Alberta, 
beginning the Professional Master's Program in Big Data at Simon Fraser University in Fall 2017. Looking for 
internship positions pertaining to data science, machine learning, probabalistic modeling, and related fields}}
...
{\raggedright\textsc{\textbf{Contract Developer} \hfill August 2016 -- Present\\
& \textit{Four Winds and Associates \\
}}}
\begin{itemize}
  \item Development and maintenence of various web applications built in python with django web-framework
  \item Working from home, coordinating with another contractor, attending meetings and phone calls to acquire task specification
\end{itemize}\\ \\
...
{\raggedright\textsc{\textbf{Junior Developer} \hfill May 2015 -- August 2015\\
& \textit{Government of the Northwest Territories \\
& Dpt. Justice\\
& Informatics \\
}}}
\begin{itemize}
  \item Assisted senior developer in building and maintaining web components for the Justice website https://www.justice.gov.nt.ca
  \item Developed a RESTful API using Scala with Play Framework to serve as the backend for online fines payment
  \item Developed Wordpress Plugins in HTML/PHP
\end{itemize}\\ \\
...
{\raggedright\textsc{\textbf{Helpdesk Analyst} \hfill September 2014}\\
& \textit{University of Alberta \hfill \textsc{September 2013 -- May 2014} \\
& Dpt. Computing Science \hfill \textsc{January 2013 -- May 2013}\\
}}}
\begin{itemize}
  \item Extensive experience with Linux systems and networks
  \item Interpersonal experience in working directly and indirectly with users 
\end{itemize}\\ \\
...
{\raggedright\textsc{\textbf{Business Support Analyst} \hfill May 2014 -- August 2014\\
& \textit{Government of the Northwest Territories \\
& Dpt. Health and Social Services \\
& Information Services \\
}}}
\begin{itemize}
  \item Assisted senior analysts in maintaining and developing systems relating to a
...
2011 -- 2016 & \textbf{Bachelor of Science} \\ 
& \textsc{Specialization Computing Science} \\ 
...
2015 -- 2016 & \textbf{Continuing Education} \\ 
& \textsc{Machine Learning}  \\ 
& \textit{Stanford University (via Coursera.com)}\\ \\
& \textsc{Probabilistic Graphical Models}  \\ 
& \textit{Stanford University (via Coursera.com)}\\ \\
& \textsc{Deep Learning Using Tensorflow}  \\ 
...
\raisebox{-3pt}{\house} & 11007 - 83\textsuperscript{rd} ave Suite 903 Edmonton AB \\ % Address
\raisebox{-3pt}{\Mobilefone} & 587-501-3566 \\ % Phone number
\raisebox{-1pt}{\Letter} & \href{mailto:swanders@ualberta.ca}{swanders@ualberta.ca} \\ % Email address
\raisebox{-1pt}{\Mundus} & \url{http://www.shawnwanderson.com} \\% Website
\raisebox{-1pt}$ ${\github} & \href{https://github.com/shawnwanderson}{shawnwanderson} \\ % Github
\end{tabular}
}
}\\[10pt]
...
\raggedright\textbf{Datascience Toolbox}
    \begin{center}\begin{tabular}{ l l l l }
        Python &  Numpy & Pandas & Matplotlib &
        SKLearn & Keras & Tensorflow & Ipython &  
    \end{tabular}
\end{center}
        
\raggedright\textbf{Programming}
    \begin{center}\begin{tabular}{ l l l l }
        Python & Linux & Object Oriented & SQL/DBMS &
        Scala  & Git   & RESTful         & HTML/CSS &  
        C++    & Vim   & Functional      & Tmux/Slimux &
    \end{tabular}
\end{center}

\raggedright\textbf{Algorithmic Skills}
    \begin{center}\begin{tabular}{ l l }
        Machine Learning & Neural Networks &
        Reinforcement Learning & Bayesian Modeling  & 
        Graph Theory & Topology & Combinatorics &
        Complex Analysis & Convex Geometry & Group Theory & 
    \end{tabular}
\end{center}
...
{\raggedright\textsc{\textbf{Instrument Recognition in African Music Field Recordings} \hfill September 2015 -- December 2015\\
& \textit{University of Alberta \\
}}}
\begin{itemize}
...
%	Research 2
%----------------------------------------------------------------------------------------
{\raggedright\textsc{\textbf{Movement Prediction Based on EEG Signals Using Hidden Markov Models} 
\\& \textit{Univesity of Alberta \hfill January 2016 -- April 2016\\ 
}}}
\begin{itemize}
  \item Given EEG data recorded on subjects in both rest and movement, my team generated a model to predict movement intention
\end{itemize}\\
...
\begin{itemize}
  \item Vice President Social Executive member of the Undergraduate Association of Computing Science
  \item Leader and Organiser of The Yellowknife Super Smash Bros. club
