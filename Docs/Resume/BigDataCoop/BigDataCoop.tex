...
\raggedright\textbf{Big Data Toolbox}
    \begin{center}\begin{tabular}{ l l l l }
        MapReduce & Cassandra & Spark & Pandas &
...
\raggedright\textbf{Algorithmic}
    \begin{center}\begin{tabular}{ l l l }
        Machine Learning & Neural Networks & Graph Theory &
        Reinforcement Learning & Bayesian Modeling & Geometry &
    \end{tabular}
\end{center}
...
{\raggedright\textsc{\textbf{Software Engineer} \hfill September 2017 -- Present\\
& \textit{Fire Out \\
}}}
\begin{itemize}
  \item Implementing and training a model to detect the presence and growth of fire in a video stream 
  \item Model training with Tensorflow, model execution on a Rasberry Pi
\end{itemize}\\ \\
...
{\raggedright\textsc{\textbf{Contract Developer} \hfill August 2016 -- September 2017\\
& \textit{Four Winds and Associates \\
}}}
\begin{itemize}
  \item Full stack development of various web applications 
...
{\raggedright\textsc{\textbf{Junior Developer} \hfill May -- August 2015\\
& \textit{Government of the Northwest Territories \\
& Dpt. Justice - Informatics \\
}}}
\begin{itemize}
...
{\raggedright\textsc{\textbf{Business Support Analyst} \hfill May -- August 2014\\
& \textit{Government of the Northwest Territories \\
& Dpt. Health and Social Services - Information Services \\
}}}
\begin{itemize}
...
{\raggedright\textsc{\textbf{Helpdesk Analyst} \hfill \textsc{September 2013 -- May 2014} \\
...
\raisebox{-1pt}{\Letter} & \href{mailto:shawn_anderson@sfu.ca}{shawn_anderson@sfu.ca} \\ % Email address
...
\section{Professional Development} 
    \begin{itemize}
        \item Teaching Assistant \\ \textsc{Implications of a Computerized Society} \\ \textit{Simon Fraser University}
        \item \textsc{Machine Learning} \\ \textit{Stanford University (via Coursera.com)}
        \item \textsc{Probabilistic Graphical Models} \\ \textit{Stanford University (via Coursera.com)}
        \item \textsc{Deep Learning Using Tensorflow} \\ \textit{Google (via udacity.com)} 
        \item \textsc{Bitcoin and Cryptocurrency Technologies} \\ \textit{Princeton University (via Coursera.com)} 
\end{itemize}\\
...
% EDUCATION 1
%------------------------------------------------
\textbf{MSc in Computing Science, Big Data} \textsc{September 2017 -- Present}\\ 
...
% EDUCATION 2
%------------------------------------------------
\textbf{BSc in Computing Science} \textsc{September 2011 -- April 2016}\\ 
