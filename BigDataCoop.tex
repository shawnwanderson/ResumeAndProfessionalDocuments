...
\par{\textbf{Big Data student at Simon Fraser University}}
%----------------------------------------------------------------------------------------
...
\raggedright\textbf{Algorithmic}
    \begin{center}\begin{tabular}{ l l l }
        ...
        Reinforcement Learning & Bayesian Modeling & Probability &
    \end{tabular}
\end{center}
...
\section{Professional Development} 
    \begin{itemize}
        \item  \\ \textsc{Implications of a Computerized Society} \\ 
            \textsc{Teaching Assistant} \\
        \textsc{September 2017 -- December 2017}\\
        \textit{Simon Fraser University} 

    \item \textsc{Deep Learning Using Tensorflow} \\ 
        \textsc{December 2016} \\
        \textit{Google (via udacity.com)} 

    \item \textsc{Bitcoin and Cryptocurrency Technologies} 
        \textsc{August 2016}
        \textit{Princeton University (via Coursera.com)} 

    \item \textsc{Probabilistic Graphical Models} \\ 
        \textsc{April 2016}\\
...
% EDUCATION 1
%------------------------------------------------
\textbf{MSc. Computing Science, Big Data Program} \\
\textsc{September 2017 -- Present}\\ 
...
% EDUCATION 2
%------------------------------------------------
\textbf{BSc. Computing Science} \\
\textsc{September 2011 -- April 2016}\\ 
